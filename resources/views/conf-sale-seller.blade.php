...
<head>
    ...
    <title>Confirmar Venda - Vendedor</title>
</head>
...
<body class="text-center">
    ...
    <main>
        <fieldset class="container mt-5 border p-2">
            <legend class="w-auto text-primary p-1 text-left"><b>Modo de Pagamento</b></legend>
            <form action="{{route('confirm.sale')}}" method="POST">

                <div class="col-4 mx-auto"><select name="payment" id="" required class="form-control  custom-select">
                ...
                @csrf
                <button type="submit" class="btn btn-primary mt-2 col-2">Confirmar Venda &nbsp;<span
                        class="fas fa-cash-register"></span></button>
            </form>
        </fieldset>
    </main>
</body>
