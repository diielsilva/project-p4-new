    ...
    <main>
        ...
        <table class="table table-striped table-bordered container mt-5">
            <tr class="bg-primary">
                ...
                <td><b class="text-white">Descrição&nbsp;<span class="fas fa-clipboard-list"></span></b></td>
            ...
            <tr>
                ...
                <td>
                    <a href="http://localhost/prototype/admin/edit/product/{{$item->id}}"><button
                            class="btn btn-primary">Editar &nbsp;<span class="fas fa-pencil-alt"></span></button></a>
                </td>
            </tr>
            @endforeach
        </table>
        @if (Session::exists('success'))
        <p class="alert alert-success mx-auto col-4 mt-3">{{Session::get('success')}}</p>
        @endif
        @if (Session::exists('error'))
        <p class="alert alert-danger mx-auto col-4 mt-3">{{Session::get('error')}}</p>
        @endif
    </main>
</body>
